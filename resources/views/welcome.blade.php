        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <form name="premio" id="form">
                    ...
                    <p>
                        <select class="js-players {{ $form['team'] ? '' : 'hidden' }}" name="player" required></select>
                    </p>
    
                    <p class="reason {{ $form['player'] && $form['team'] ? '' : 'hidden' }}">
                    ...
                    <p class="submit {{ $form['player'] && $form['team'] ? '' : 'hidden' }}">
                        @if (!$is_logged)
